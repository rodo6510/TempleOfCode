    //   |     ./donut number_of_rings number_of_segments time
    //   |  _  |   _    |  _   _   _  _
...
int a0=40,a1=80,cx=0,cy=0,cz=10,mx=40,my=20,scale=1;              float ax=10,
ay=20,az=10;int change=0,i=10,t=0,j=0,x=0,y=0,              z=0,n=0,xd=0,yd=0,
zd=0,zx=0,zy=0,yx=0,yz=0,                                     xy=0,xz=0,xro=0,
yro=0,zro=0;                                                      double px=0,
                                                            py=0;char o[8000];
                                              typedef struct{ int x,y,z;} p3d;
/*        ____________________ */     p3d myp_temp;p3d*myp3d; p3d *myp_zt;void
/*       |                    |\ */        pp(int x,int y,int tex){o[x+(y*a1)]
/*       |                    | \ */             =tex;}float cosaz; float saz;
/*       |                    |  \ */
/*       |                    |   \ */      float cay;float sine_ay;float cax;
/*       |                    |    \ */       float sine_ax;int main(int argc,
/*       |                    |     | */         char *argv[]){int nr, ns; if(
/*       |                    |     | */     
/*       |                    |     | */         argc < 4)return -1;nr = atoi(
/*       |                    |     | */             argv     [1]);ns     = 
/*       |                    |     | */
/*       |                    |     | */
/*       |                    |     | */                  atoi      (argv[2])
...
/*       |            |                      |      |   */  = 14.0f ; float r2
/*       |            |                      |      |   */  
/*       |            |                  _____________________  */=7.0f;myp3d=  
/*       |            |                 |                     |~~-_  */ malloc
/*       |            |                 |                     |    ~~-_  */ ((
/*       |            |                 |                     |        |    */
/*       |            |                 |                     |        |    */
...
/*       |            |                 |                     |        |    */
/*       |            |                 |                     |        |    */
/* ______|____________|_________________|_____________________|________|____*/
/*       |            |                 |                     |        |    */
/*       .            .                 .                     .        .    */
/*        -            -                 -                     -        -   */
/*      -            -                 -                     -        -     */
